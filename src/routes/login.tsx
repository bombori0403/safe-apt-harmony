        ...
        <div className="w-full max-w-sm">
          <div className="mb-8 lg:hidden text-center">
            <Link to="/" className="inline-flex items-center justify-center mb-3">
              <img src="/logo-mark.png" alt="리스크로그" className="w-16 h-16 rounded-full object-cover shadow-lg shadow-primary/20" />
            </Link>
            <h1 className="text-2xl font-bold tracking-tight">리스크로그</h1>
