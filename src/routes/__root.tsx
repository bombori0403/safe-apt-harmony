...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://tanstack-start-app.anjeondesk.workers.dev/og-riskeulog-v2.png" },
      { name: "twitter:image", content: "https://tanstack-start-app.anjeondesk.workers.dev/og-riskeulog-v2.png" },
