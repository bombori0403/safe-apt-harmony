      ...
      <section className="max-w-6xl mx-auto px-4 py-16 md:py-24">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <Step n="02" title="위험성 결정 · 감소대책"
            desc="선택한 평가방법에 맞춰 위험성을 산정하고, 자동 매칭된 법령(법적 근거)을 확인해 맞지 않으면 직접 수정한 뒤 감소대책을 세웁니다." />
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 md:py-24">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            <Feature icon={ScrollText} title="관련 법조문 자동 매칭 · 확인 후 수정"
              desc="유해·위험요인을 입력하면 산업안전보건기준에 관한 규칙 등 관련 법적기준이 자동으로 제안됩니다. 제안은 참고용으로 정확성을 보장하지 않으니, 담당자가 반드시 확인하고 맞지 않으면 직접 수정하세요." />
