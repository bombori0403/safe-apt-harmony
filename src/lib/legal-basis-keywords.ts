...
const RULES: Rule[] = [
  ...
  { keywords: ["감전", "활선", "충전부"], article_no: "제301조", legal_basis: "산업안전보건기준에 관한 규칙 제301조(전기 기계·기구 등의 충전부 방호)" },
  { keywords: ["누전", "차단기", "절연", "정전"], article_no: "제302조", legal_basis: "산업안전보건기준에 관한 규칙 제302조(전기 기계·기구 등의 접지)" },
  { keywords: ["신나", "페인트", "소독약", "반응성", "유기용제"], article_no: "위험물법 제26조", legal_basis: "위험물안전관리법 제26조(저장·취급기준 준수명령 등)" },
  { keywords: ["화재", "폭발", "가스", "유류", "화상", "배관 파손"], article_no: "제232조", legal_basis: "산업안전보건기준에 관한 규칙 제232조(폭발 또는 화재 등의 예방)" },
  { keywords: ["입출차", "과속", "제한속도", "차량 속도"], article_no: "제98조", legal_basis: "산업안전보건기준에 관한 규칙 제98조(제한속도의 지정 등)" },
  { keywords: ["낙하", "와이어로프", "비산물", "파손에 의한 충돌"], article_no: "제14조", legal_basis: "산업안전보건기준에 관한 규칙 제14조(낙하물에 의한 위험의 방지)" },
  { keywords: ["충돌", "부딪"], article_no: "제200조", legal_basis: "산업안전보건기준에 관한 규칙 제200조(충돌위험 방지)" },
  ...
  { keywords: ["농약", "방제", "살포"], article_no: "제670조", legal_basis: "산업안전보건기준에 관한 규칙 제670조(농약원재료 방제작업 시의 조치)" },
  { keywords: ["약품", "화학물질", "누출", "유출"], article_no: "제395조", legal_basis: "산업안전보건기준에 관한 규칙 제395조(누출ㆍ유출 등에 대비한 조치)" },
  { keywords: ["근골격계"], article_no: "제657조", legal_basis: "산업안전보건기준에 관한 규칙 제657조(유해요인 조사)" },
  { keywords: ["작업환경 개선", "반복작업"], article_no: "제659조", legal_basis: "산업안전보건기준에 관한 규칙 제659조(작업환경 개선)" },
  { keywords: ["작업지휘자", "중량물"], article_no: "제39조", legal_basis: "산업안전보건기준에 관한 규칙 제39조(작업지휘자의 지정)" },
  { keywords: ["휴식"], article_no: "제566조", legal_basis: "산업안전보건기준에 관한 규칙 제566조(휴식 등)" },
  { keywords: ["협착", "회전체", "회전축", "끼임"], article_no: "제87조", legal_basis: "산업안전보건기준에 관한 규칙 제87조(원동기·회전축 등의 위험 방지)" },
  { keywords: ["방호장치"], article_no: "제134조", legal_basis: "산업안전보건기준에 관한 규칙 제134조(방호장치의 조정)" },
  { keywords: ["장갑"], article_no: "제95조", legal_basis: "산업안전보건기준에 관한 규칙 제95조(장갑의 사용금지)" },
